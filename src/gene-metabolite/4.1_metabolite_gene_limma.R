...
# ---------------------------------------------------------------------------
# Limma-voom loop: test each metabolite against pseudobulk gene
# expression in every qualifying cell type. Streams one parquet per metabolite.
#
...
# Downstream: metabolite_gene_associations.Rmd
#
# Submit via: sbatch run_metabolite_gene_limma.sh in bin/docker
# ---------------------------------------------------------------------------
...
source(file.path(root, "src/gene-metabolite/pseudobulk_functions.R"))     # build_pseudobulk, merge_hormone_metadata, .safe_vars
source(file.path(root, "src/gene-metabolite/metabolite_functions.R"))     # metabolite transform + analysis helpers
