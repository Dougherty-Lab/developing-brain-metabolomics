# =============================================================================
# plot_pair_spotlight_dfbetas.R  —  Gene × Metabolite × Cell-type spotlight
# =============================================================================
# Same 5-panel scatter as plot_pair_spotlight.R but reads from the
# DFBETAS-stable robust set (metabolite_gene_hits_robust.csv).
#
# 5 panels:
...
# Copy values directly from metabolite_gene_hits_robust.csv (DFBETAS-stable set)
PAIRS <- list(
...
hits_csv     <- "../../results/gene-metabolite/stability-dfbetas-log2_na/metabolite_gene_hits_robust.csv"
scatter_dir  <- "../../results/gene-metabolite/stability-dfbetas-log2_na/scatter-spotlight"
